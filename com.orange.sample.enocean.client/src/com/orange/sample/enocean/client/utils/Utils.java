...
public class Utils {
	 ...
	 * @param a
	 * @param b
	 * @return the two bytes concatenated
	 */
	 ...
	 * @param x
	 * @param max
	 * @return a byte array that contains the result of the concatenation of a
	 *         byte array and an int, up to max bytes from the right
	 */
